...
{
    float4 screen = TransformObjectToHClip(Position) * 0.5f;
    screen.xy = float2(screen.x, screen.y * _ProjectionParams.x) + screen.w;
    screen.zw = TransformObjectToHClip(Position).zw;
